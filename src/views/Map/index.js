  ...
  displayInfoStation() {
    ...
    return (
      <div className="Map__CityInfo">
        <h3>{this.state.selectedStation.name}, {this.state.selectedStation.City.name}</h3>
        <div className="Map__ReadingsInfo">
          {pollutants.map(pollutant => <div key={pollutant.name} className="Map__ReadingsInfoItem">
        ...
        < div className="Map_Container" >
          ...
          >
            {this.state.stations.map(station =>
              <Marker key={station.id} latitude={station.latitude} longitude={station.longitude} offsetLeft={-20} offsetTop={-10}>
